...
public class Main {
    ...
    public static final String BASE_URI = "http://localhost:9080/maven-intro/rest/";
    ...
    public static HttpServer startServer() throws IOException {
        ...
        httpServer.getServerConfiguration().addHttpHandler(new StaticHttpHandler("src/main/webapp"), "/maven-intro");
        httpServer.start();
        return httpServer;
    }
